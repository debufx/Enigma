...
from enigma.rotors import factory as f
from enigma import plugboard as p
from enigma import keyfile as k
...
class EnigmaMachine:
    ...
    def from_key_sheet(cls, rotors='I II III', ring_settings=None,
        ...
        rotor_list = [f.create_rotor(r[0], r[1]) for r in zip(rotors, ring_settings)]

        return cls(rotor_list,
                   f.create_reflector(reflector),
                   p.Plugboard.from_key_sheet(plugboard_settings))
    ...
    def from_key_file(cls, fp, day=None):
        ...
        """
        args = k.get_daily_settings(fp, day)
